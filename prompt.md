...
3. Use Python for the analysis and save the code as `analysis.py` so I can review and reproduce the results.
4. Build a single-file `dashboard.html` that I can open in a browser. Include the regression result, price trends over time, organic vs conventional comparison, and top markets by volume. Make it look professional.
